window.onload = function () {
    ...
    if (res_t1 > res_t2) {
        document.getElementById("Win_team").value = "INDIA won by " + (res_t1 - res_t2) + " runs";
    }
    else if (res_t1 < res_t2) {
        document.getElementById("Win_team").value = "PAKISTAN won by " + (res_t2 - res_t1) + " runs";
    }
    else {
        document.getElementById("Win_team").value = "Match is tie";
    }
